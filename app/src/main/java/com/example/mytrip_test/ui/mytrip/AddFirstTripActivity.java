...
import static com.example.mytrip_test.ui.mytrip.Constants.API_LINK_V2;

public class AddFirstTripActivity extends PlaceList
        implements DatePickerDialog.OnDateSetListener, View.OnClickListener {

    EditText trip_name;
    TextView trip_date;
    Spinner trip_location;
    Button btn_firstplace;
    Button btn_ok_first;
    Button save;
...
//  LottieAnimationView animationView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_new_trip_firstcourse);
...
//      animationView = findViewById(R.id.animation_view);
        ...
        //list button
        btn_firstplace = findViewById(R.id.btn_firstplace);
        btn_firstplace.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AddFirstTripActivity.this, PlaceListSecond.class);
                ...
                try {
                    ...
                    mHandler.post(() -> {
                        if (responseCode == HttpsURLConnection.HTTP_CREATED) {
                            TravelmateSnackbars.createSnackBar(findViewById(R.id.activityAddFirstTrip),
